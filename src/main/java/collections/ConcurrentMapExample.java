...
public class ConcurrentMapExample {
    ...
    private final ConcurrentMap<SubscriptionId, SubscriptionContext> subscriptionToContext = new ConcurrentHashMap<>();
    ...
    private void closeSubscription(SubscriptionId id) {
