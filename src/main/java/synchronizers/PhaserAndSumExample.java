...
public class PhaserAndSumExample {
    ...
    class Worker extends Thread {
        ...
        @Override
        public void run() {
            for (Integer soldItemsElement : partialArray) {
                sum += soldItemsElement;
            }
            ...
            System.out.println("Derigister. The Phase " + phase + " is completed in the thread " + getName());
        }
    }
}